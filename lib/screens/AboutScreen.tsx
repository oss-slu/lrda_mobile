  ...
  return (
    <View className="flex-1 bg-primary">
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        <Text className="text-foreground text-2xl font-bold mb-5 text-center">About Where's Religion?</Text>
        <Text className="text-foreground text-base leading-6 mb-4 text-justify">
