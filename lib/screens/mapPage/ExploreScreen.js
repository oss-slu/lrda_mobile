...
const ExploreScreen = () => {
  ...
  const [searchTipVisible, setSearchTipVisible] = useState(true);
  const [mapViewVisible, setMapView] = useState(false);
  ...
  useEffect(() => {
    const initialize = async () => {
      const tutorialStatus = await User.getHasDoneTutorial("explore_screen");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mapTypeSelector}>
        ...
        <Tooltip
              isVisible={mapViewVisible && !tutorialDone}
              ...
              content={
                <View>
                  <Text style = {styles.buttonText}>Change map here</Text>
                  <Button
                  ...
                  <Text 
                    ...
                    onPress={() => {
                      setMapView(false);
                      User.setUserTutorialDone("explore_screen", true);
                    }}
                  >
                    Skip Tutorial
                  </Text>
      ...
      <View style={styles.searchBox}>
        ...
        />
        <Tooltip
              isVisible={searchTipVisible && !tutorialDone}
              showChildInTooltip={false}
              topAdjustment={Platform.OS === "android" ? -30 : 0} // Set to -30 for Android, 0 otherwise
              ...
              content={
                <View>
                  <Text style = {styles.buttonText}>Search Locations Here!</Text>
                  <Button
                    style={styles.gotItButton}
                    onPress={() => {
                      setSearchTipVisible(false);
                      setTimeout(() => setMapView(true), 100);
                      User.setUserTutorialDone("explore_screen", true);
                    }}
                  >
                    <Text style={styles.gotItButtonText}>Got it!</Text>
