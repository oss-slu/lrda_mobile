...
const ExploreScreen = () => {
  ...
  const fetchMessages = async () => {
    try {
      const fetchedNotes = await ApiService.fetchMessages(true, false, "someUserId");
      const fetchedMarkers = fetchedNotes.map((note) => ({
        ...
        images: note.media.map((mediaItem) => ({ uri: mediaItem.uri })) || require("../../../assets/map_marker.png"), // need to replace with placeholder image
