...
const ExploreScreen = () => {
  ...
  const styles = StyleSheet.create({
    ...
    selectedMapType: {
      fontWeight: 'bold',
      // ... Additional styling to indicate selection
    },
  });
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mapTypeSelector}>
        <TouchableOpacity onPress={() => setMapType('standard')}>
          <Text style={mapType === 'standard' ? styles.selectedMapType : styles.mapType}>2D</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => setMapType('satellite')}>
          <Text style={mapType === 'satellite' ? styles.selectedMapType : styles.mapType}>Satellite</Text>
        </TouchableOpacity>
      </View>
